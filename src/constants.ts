...
export const LIGHT_COLORS = {
  ...
  "--color-decorative-100": "hsl(50deg 80% 97%)",
  "--color-decorative-200": "hsl(50deg 80% 94%)",
  "--color-decorative-300": "hsl(50deg 80% 90%)",
  "--color-decorative-500": "hsl(50deg 80% 80%)",
  "--color-decorative-600": "hsl(50deg 80% 70%)",
  "--color-decorative-700": "hsl(50deg 80% 60%)",
  "--color-decorative-800": "hsl(50deg 80% 45%)",
  "--color-decorative-900": "hsl(50deg 80% 35%)",
  "--color-gray-0": "white",
  "--color-gray-100": "hsl(50deg 15% 93%)",
  "--color-gray-200": "hsl(50deg 12% 89%)",
  "--color-gray-300": "hsl(50deg 8% 75%)",
...
export const DARK_COLORS = {
  ...
  "--color-primary-100": "hsl(50deg 80% 93%)",
  "--color-primary-300": "hsl(50deg 80% 75%)",
  "--color-primary-500": "hsl(50deg 80% 60%)",
  "--color-primary-700": "hsl(50deg 80% 45%)",
  "--color-primary-900": "hsl(50deg 80% 35%)",
